...
```sh
git clone https://github.com/AHWALab/TITOBurkina_Faso.git
```
...
- **hsaf_ftp_user / hsaf_ftp_pass:** Required only when `qpe_source = "HSAF"`. Register at HSAF and provide your FTP credentials.
